...
#This program creates five green circles in the shape of a flower and then five red smaller circles on top of it and then creates a purple image in the middle of the flower. It then repeats this five times to make 5 flowers.
